...
Route::post('/loginMember', ['as' => 'postLoginMember', 'uses' => 'Auth\AuthController@postLoginMember']);
Route::post('/signUpMember', ['as' => 'postLoginMember', 'uses' => 'Auth\AuthController@signUpMember']);
...
Route::group(['prefix' => 'api', 'middleware' => 'api'], function() {
    ...
    Route::post('/login-customer', ['as' => 'api.login-customer', 'uses' => 'Api\FrontendController@loginCustomer']);
