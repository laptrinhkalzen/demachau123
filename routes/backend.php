...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function() {
    ...
    /* Quản lý email */
    Route::get('/email', ['as' => 'admin.email.index', 'uses' => 'Backend\EmailController@index']);
    Route::get('/email/create', ['as' => 'admin.email.create', 'uses' => 'Backend\EmailController@create']);
    Route::post('/email/store', ['as' => 'admin.email.store', 'uses' => 'Backend\EmailController@store']);
    Route::get('/email/edit/{id}', ['as' => 'admin.email.edit', 'uses' => 'Backend\EmailController@edit']);
    Route::post('/email/update/{id}', ['as' => 'admin.email.update', 'uses' => 'Backend\EmailController@update']);
    Route::delete('/email/delete/{id}', ['as' => 'admin.email.destroy', 'uses' => 'Backend\EmailController@destroy']);

    /* Quản lý email_attribute */
    Route::get('/email_attribute', ['as' => 'admin.email_attribute.index', 'uses' => 'Backend\EmailAttributeController@index']);
    Route::get('/email_attribute/create/{id}/{status}', ['as' => 'admin.email_attribute.create', 'uses' => 'Backend\EmailAttributeController@create']);
    Route::post('/email_attribute/store', ['as' => 'admin.email_attribute.store', 'uses' => 'Backend\EmailAttributeController@store']);
    Route::get('/email_attribute/edit/{id}', ['as' => 'admin.email_attribute.edit', 'uses' => 'Backend\EmailAttributeController@edit']);
    Route::post('/email_attribute/update/{id}', ['as' => 'admin.email_attribute.update', 'uses' => 'Backend\EmailAttributeController@update']);
    Route::delete('/email_attribute/delete/{id}', ['as' => 'admin.email_attribute.destroy', 'uses' => 'Backend\EmailAttributeController@destroy']);
