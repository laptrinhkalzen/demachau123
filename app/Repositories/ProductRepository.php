...
class ProductRepository extends AbstractRepository {
    ...
    public function readCategoryProduct($category) {
        $product = \DB::table('product_category')->where('category_id',$category)->pluck('product_id');
        return $this->model->whereIn('id',$product)->paginate(10);
    }
    ...
    public function getFilterProduct($genre,Request $request){
         $i=0;
         $i1=0;
        $product_ids = \DB::table('product_category')->whereIn('category_id', $genre)->pluck('product_id');
         $product = \DB::table('product_category')->whereIn('category_id',$genre)->get();
