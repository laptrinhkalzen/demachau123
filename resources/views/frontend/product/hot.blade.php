        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div id="color_sel_Carousel-content_02" class="tab-content position-relative w-100">
              ...
              <!-- tab item -->
              <div class="tab-pane fade show" id="mp-2-02-c" role="tabpanel" aria-labelledby="mp-2-02-tab">
                <div class="row">
                  <!-- item -->
              ...
              <div class="tab-pane fade show" id="mp-2-03-c" role="tabpanel" aria-labelledby="mp-2-03-tab">
                <div class="row">
                  <!-- item -->
