...
@section('content')
    <div class="content">
        <form action="{!!route('admin.email_attribute.store')!!}" method="POST" enctype="multipart/form-data">
            <div class="card">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="left-icon-tab1">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="title" value="{!! $email_form->title!!}">
                                ...
                                @foreach($order_detail as $key => $orders_detail)
                              <textarea id="textareaid"></textarea>
                                <a href="#"  onclick="insertAtCaret('textareaid', '{{$orders_detail->product_name}}');return false;">Click Here to Insert</a>
                                    @if($key>0)
                                        @break;
                                    @endif
                                @endforeach
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea  class="form-control ckeditor" id="textareaid" name="content">{!!$email_form->content !!}</textarea>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <a type="button" href="{{route('admin.email_attribute.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
