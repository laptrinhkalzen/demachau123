    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Gửi mail</span></a>
                    <ul class="nav nav-group-sub" data-submenu-title="Gửi Email">
                        <li class="nav-item"><a href="{{route('admin.email.index')}}" class="nav-link">Nhập dữ liệu mail</a></li>
                        <li class="nav-item"><a href="{{route('admin.email_attribute.index')}}" class="nav-link">Gửi mail</a></li>
                    </ul>
                </li>
                <li class="nav-item nav-item-submenu">
