                    ...
                    <div class="card-header header-elements-inline">
                        ...
                        <div class="btn-group justify-content-center">
                            ...
                            <div class="dropdown-menu" x-placement="top-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, -183px, 0px);">
                                <a href="{{route('admin.email_attribute.create',[$record->id, $record->status => 1])}}" class="dropdown-item" data-order_id="{{$record->id}}"  data-status="1" class="status1">Đang xử lý</a>
                                <a href="{{route('admin.email_attribute.create',[$record->id, $record->status=> 2])}}" class="dropdown-item" data-order_id="{{$record->id}}"  data-status="2" class="status2">Xác nhận</a>
                                <a href="{{route('admin.email_attribute.create',[$record->id, $record->status=> 3])}}" class="dropdown-item" data-order_id="{{$record->id}}"  data-status="3" class="status3">Từ chối</a>
                            </div>
                        </div>
                    </div>
                    <table class="table">
